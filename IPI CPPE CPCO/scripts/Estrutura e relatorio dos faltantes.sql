...
DROP TABLE ACUMULADO_DATA_QTD_NF;
GO
DROP TABLE TEMPORARIO_ACUMULADO_DATA_QTD_NF
GO

CREATE TABLE public.ACUMULADO_DATA_QTD_NF  ( 
...
CREATE INDEX id_acumulado_data_qtd_nf_pk
	ON public.acumulado_data_qtd_nf USING btree (cnpj text_ops, ano text_ops, mes text_ops)
GO
...
SELECT  TABELA.CNPJ,
        ...
        TABELA.MES,
        TABELA.QTD
        INTO TABLE TEMPORARIO_ACUMULADO_DATA_QTD_NF
FROM 
(
    SELECT NOTAS.CNPJ          AS CNPJ,
