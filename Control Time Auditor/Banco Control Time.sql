...
UPDATE USUARIOS SET GRUPO = 905 WHERE ID = 3
GO

UPDATE USUARIOS SET GRUPO = 900 WHERE ID = 4
GO

UPDATE USUARIOS SET GRUPO =  902 WHERE ID = 5
GO

UPDATE USUARIOS SET GRUPO =  901 WHERE ID = 6
GO

select max(conta)* 2 from estruturas where id_empresa = 1
