...
"C:\Program Files\PostgreSQL\10\bin\"pg_dump.exe -h localhost -U postgres -p 5432 -f C:\backup_diane\local\tab_marcas.bak     	--verbose --role "postgres" --format=c --blobs  	    --table "os_marcas"		"db_fluxo_de_caixa"
pause
