...
"C:\Program Files\PostgreSQL\10\bin\"pg_restore -h localhost  -U postgres -p 5432  --verbose -d db_fluxo_de_caixa C:\backup_diane\local\tab_os_car.bak     		
"C:\Program Files\PostgreSQL\10\bin\"pg_restore -h localhost  -U postgres -p 5432  --verbose -d db_fluxo_de_caixa C:\backup_diane\local\tab_marcas.bak     		
pause